...
//        centerY = height / 2 + getPaddingTop();
        ...
        //时针
        hourBitmap = createBitmap(width, height, Bitmap.Config.ARGB_8888);
        hourCanvas = new Canvas(hourBitmap);

        //分针
        minuteBitmap = createBitmap(width, height, Bitmap.Config.ARGB_8888);
        minuteCanvas = new Canvas(minuteBitmap);

        //秒针
        secondBitmap = createBitmap(width, height, Bitmap.Config.ARGB_8888);
